    ...
    <div class="sales-board">
        ...
        <div class="sales-board-form">
            ...
            <div class="sales-board-line">
                ...
                <div class="sales-board-line-right">
                    <v-radio :radios="periodList" @on-change="onParamChange('period', $event)"></v-radio>
                </div>
            </div>
            <div class="sales-board-line">
                <div class="sales-board-line-left">产品版本：</div>
                <div class="sales-board-line-right">
                    <v-checkbox :checkboxs="versionList" @on-change="onParamChange('versions', $event)"></v-checkbox>
                </div>
            </div>
            <div class="sales-board-line">
        ...
        <my-dialog :is-show="isShowPayDialog" @dialogClose="hidePayDialog">
        ...
        <my-dialog :is-show="isShowErrDialog" @dialogClose="hideErrDialog">
        支付失败！
        </my-dialog>
